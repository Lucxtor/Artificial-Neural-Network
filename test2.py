...
ann_layer = initialize_layers(layers, c_inputs=2)
...
stages = train(ann=ann_layer, epochs=200, x=x_train, y=y_train, learning_rate=0.05, cost_func='binary_cross_entropy')
...
y_train = y_train.reshape(-1, 1)  # Reshape para garantir que seja uma matriz coluna

train(ann=ann_layer, epochs=100, x=x_train, y=y_train, learning_rate=0.001, cost_func='binary_cross_entropy')
